import { PathFormat, SetValueOptions } from "../core/types"
import  { keySeparator as standardKeySeparator } from './globals'
...
export const getFromPath = (baseObject, path, opts: any = {}) => {
    ...
    const keySeparator = opts.keySeparator ?? standardKeySeparator
